<template>
        ...
        <div class="mx-auto max-w-5xl">
          ...
          <div class="mt-2 space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
            <FluidGlassButton 
              ...
              :split-config="{ types: 'words, chars', delayStep: 0.015, threshold: 0 }"
            >
    ...
    >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative">
              <OptimizedImage 
                src="/images/atmosphere/main-hall.svg"
  ...
  <!-- Блоки контента -->
  <div aria-live="polite" class="relative z-30">


      <!-- Наш интерьер: Горизонтальная галерея с эффектом пролистывания -->
      <section class="py-0 w-full relative z-30" aria-labelledby="interior-title" style="background-color: var(--brand-primary-700);">
        <div class="w-full relative" ref="interiorWrap">
...
import HorizontalScrollGallery from '~/components/HorizontalScrollGallery.vue'
import FluidGlassButton from '~/components/FluidGlassButton.vue'
...
const interiorGallery = ref(null)
...
// Наш интерьер — изображения для горизонтальной галереи
const interiorImages = [
  {
    src: '/images/atmosphere/main-hall.svg',
    fallback: '/images/atmosphere/main-hall.svg',
    alt: 'Главный зал ресторана',
    title: 'Главный зал',
    description: 'Просторный и уютный зал с современным дизайном, идеально подходящий для семейных ужинов и деловых встреч'
  },
  {
    src: '/images/atmosphere/bar-counter.svg',
    fallback: '/images/atmosphere/bar-counter.svg',
    alt: 'Барная стойка',
    title: 'Барная стойка',
    description: 'Стильная барная стойка с широким выбором напитков и закусок, где можно насладиться коктейлями и винами'
  },
  {
    src: '/images/atmosphere/terrace.svg',
    fallback: '/images/atmosphere/terrace.svg',
    alt: 'Терраса ресторана',
    title: 'Терраса',
    description: 'Открытая терраса с прекрасным видом, где можно насладиться трапезой на свежем воздухе в теплое время года'
  },
  {
    src: '/images/atmosphere/wine-cellar.svg',
    fallback: '/images/atmosphere/wine-cellar.svg',
    alt: 'Винная карта',
    title: 'Винная коллекция',
    description: 'Эксклюзивная коллекция вин со всего мира, тщательно подобранная нашим сомелье для идеального сочетания с блюдами'
  }
]
...
onMounted(async () => {
  ...
  // Отзывы теперь загружаются через виджет Яндекс.Карт
  ...
  // Projects Grid теперь не требует ScrollTrigger управления
})
