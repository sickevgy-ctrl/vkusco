      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          ...
          <p class="text-gray-300 mb-4">
            Изысканная итальянская и европейская кухня в самом сердце города. 
            Мы создаем незабываемые кулинарные впечатления уже более 15 лет.
          </p>
          <div class="flex space-x-4">
            <a href="#" class="text-gray-300 hover:text-primary-400 transition-colors duration-300">
        ...
        <!-- Часы работы -->
        <div>
          <h3 class="text-lg font-semibold text-primary-400 mb-4">Часы работы</h3>
